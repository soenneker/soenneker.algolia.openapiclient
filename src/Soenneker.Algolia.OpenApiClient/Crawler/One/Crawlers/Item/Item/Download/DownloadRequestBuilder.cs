...
using System;
namespace Soenneker.Algolia.OpenApiClient.Crawler.One.Crawlers.Item.Item.Download
{
    /// <summary>
    /// Builds and executes requests for operations under \crawler\1\crawlers\{id}\{logId}\download
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class DownloadRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Algolia.OpenApiClient.Crawler.One.Crawlers.Item.Item.Download.DownloadRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DownloadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crawler/1/crawlers/{id}/{logId}/download", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Algolia.OpenApiClient.Crawler.One.Crawlers.Item.Item.Download.DownloadRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DownloadRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crawler/1/crawlers/{id}/{logId}/download", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Algolia.OpenApiClient.Crawler.One.Crawlers.Item.Item.Download.DownloadRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Algolia.OpenApiClient.Crawler.One.Crawlers.Item.Item.Download.DownloadRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Algolia.OpenApiClient.Crawler.One.Crawlers.Item.Item.Download.DownloadRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
