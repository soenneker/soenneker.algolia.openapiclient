...
namespace Soenneker.Algolia.OpenApiClient.Analytics.Two.Conversions.PurchaseRate
{
    ...
    public partial class PurchaseRateGetResponse_dates : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Algolia.OpenApiClient.Analytics.Two.Conversions.PurchaseRate.PurchaseRateGetResponse_dates"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Algolia.OpenApiClient.Analytics.Two.Conversions.PurchaseRate.PurchaseRateGetResponse_dates CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Algolia.OpenApiClient.Analytics.Two.Conversions.PurchaseRate.PurchaseRateGetResponse_dates();
        }
        /// <summary>
