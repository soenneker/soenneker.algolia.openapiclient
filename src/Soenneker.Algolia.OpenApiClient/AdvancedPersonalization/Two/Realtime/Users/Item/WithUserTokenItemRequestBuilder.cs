...
using System;
namespace Soenneker.Algolia.OpenApiClient.AdvancedPersonalization.Two.Realtime.Users.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \advanced-personalization\2\realtime\users\{userToken}
    /// </summary>
    ...
    public partial class WithUserTokenItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithUserTokenItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/advanced-personalization/2/realtime/users/{userToken}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Algolia.OpenApiClient.AdvancedPersonalization.Two.Realtime.Users.Item.WithUserTokenItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserTokenItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/advanced-personalization/2/realtime/users/{userToken}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Algolia.OpenApiClient.AdvancedPersonalization.Two.Realtime.Users.Item.WithUserTokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Algolia.OpenApiClient.AdvancedPersonalization.Two.Realtime.Users.Item.WithUserTokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
