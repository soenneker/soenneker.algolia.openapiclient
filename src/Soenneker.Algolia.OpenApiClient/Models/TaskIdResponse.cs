...
namespace Soenneker.Algolia.OpenApiClient.Models
{
    ...
    public partial class TaskIdResponse : IParsable
    #pragma warning restore CS1591
    {
        ...
        public static global::Soenneker.Algolia.OpenApiClient.Models.TaskIdResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Algolia.OpenApiClient.Models.TaskIdResponse();
        }
        /// <summary>
