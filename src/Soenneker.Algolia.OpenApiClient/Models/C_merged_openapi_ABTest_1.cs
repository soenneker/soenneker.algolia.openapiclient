...
namespace Soenneker.Algolia.OpenApiClient.Models
{
    ...
    public partial class C_merged_openapi_ABTest_1 : IParsable
...
#nullable restore
        ...
        public global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_Status_2? Status { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant_1>? Variants { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant_1> Variants { get; set; }
#endif
        ...
        public static global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_ABTest_1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_ABTest_1();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_Status_2>(); } },
                { "stoppedAt", n => { StoppedAt = n.GetStringValue(); } },
                { "updatedAt", n => { UpdatedAt = n.GetStringValue(); } },
                { "variants", n => { Variants = n.GetCollectionOfObjectValues<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant_1>(global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant_1.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_Status_2>("status", Status);
            writer.WriteStringValue("stoppedAt", StoppedAt);
            writer.WriteStringValue("updatedAt", UpdatedAt);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant_1>("variants", Variants);
        }
    }
}
