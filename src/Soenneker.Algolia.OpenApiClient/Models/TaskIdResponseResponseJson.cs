...
namespace Soenneker.Algolia.OpenApiClient.Models
{
    ...
    public partial class TaskIdResponseResponseJson : IParsable
    #pragma warning restore CS1591
    {
        ...
        public static global::Soenneker.Algolia.OpenApiClient.Models.TaskIdResponseResponseJson CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Algolia.OpenApiClient.Models.TaskIdResponseResponseJson();
        }
        /// <summary>
