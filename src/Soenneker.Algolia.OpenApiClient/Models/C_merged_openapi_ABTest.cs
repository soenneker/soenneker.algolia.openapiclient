...
namespace Soenneker.Algolia.OpenApiClient.Models
{
    ...
    public partial class C_merged_openapi_ABTest : IParsable
...
#nullable restore
        ...
        public global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_Status? Status { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant>? Variants { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant> Variants { get; set; }
#endif
        ...
        public static global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_ABTest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_ABTest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_Status>(); } },
                { "stoppedAt", n => { StoppedAt = n.GetStringValue(); } },
                { "updatedAt", n => { UpdatedAt = n.GetStringValue(); } },
                { "variants", n => { Variants = n.GetCollectionOfObjectValues<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant>(global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_Status>("status", Status);
            writer.WriteStringValue("stoppedAt", StoppedAt);
            writer.WriteStringValue("updatedAt", UpdatedAt);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Algolia.OpenApiClient.Models.C_merged_openapi_variant>("variants", Variants);
        }
    }
}
