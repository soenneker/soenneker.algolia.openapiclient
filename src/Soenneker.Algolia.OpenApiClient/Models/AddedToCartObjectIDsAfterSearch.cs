...
namespace Soenneker.Algolia.OpenApiClient.Models
{
    ...
    public partial class AddedToCartObjectIDsAfterSearch : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public global::Soenneker.Algolia.OpenApiClient.Models.AddToCartEvent? EventSubtype { get; set; }
        /// <summary>The eventType property</summary>
        public global::Soenneker.Algolia.OpenApiClient.Models.ConversionEvent? EventType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Algolia.OpenApiClient.Models.ObjectDataAfterSearch>? ObjectData { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Algolia.OpenApiClient.Models.ObjectDataAfterSearch> ObjectData { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Algolia.OpenApiClient.Models.AddedToCartObjectIDsAfterSearch"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Algolia.OpenApiClient.Models.AddedToCartObjectIDsAfterSearch CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Algolia.OpenApiClient.Models.AddedToCartObjectIDsAfterSearch();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "eventSubtype", n => { EventSubtype = n.GetEnumValue<global::Soenneker.Algolia.OpenApiClient.Models.AddToCartEvent>(); } },
                { "eventType", n => { EventType = n.GetEnumValue<global::Soenneker.Algolia.OpenApiClient.Models.ConversionEvent>(); } },
                { "index", n => { Index = n.GetStringValue(); } },
                { "objectData", n => { ObjectData = n.GetCollectionOfObjectValues<global::Soenneker.Algolia.OpenApiClient.Models.ObjectDataAfterSearch>(global::Soenneker.Algolia.OpenApiClient.Models.ObjectDataAfterSearch.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Algolia.OpenApiClient.Models.AddToCartEvent>("eventSubtype", EventSubtype);
            writer.WriteEnumValue<global::Soenneker.Algolia.OpenApiClient.Models.ConversionEvent>("eventType", EventType);
            writer.WriteStringValue("index", Index);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Algolia.OpenApiClient.Models.ObjectDataAfterSearch>("objectData", ObjectData);
